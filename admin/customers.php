...
$count_query = "SELECT COUNT(*) FROM users u WHERE u.role = 'user'";
$count_params = [];
...
<head>
    ...
    <title>Customers - SHOPWAVE Admin</title>
    ...
    <style>
        .customers-table { font-size: 0.8rem; }
        .customers-table th { padding: 0.5rem 0.6rem; white-space: nowrap; }
        .customers-table td { padding: 0.5rem 0.6rem; white-space: nowrap; }
        .customers-table .customer-avatar { width: 32px; height: 32px; font-size: 0.8rem; flex-shrink: 0; }
        .card { overflow-x: auto; }
        .pagination-btn { min-width: 28px; height: 28px; font-size: 0.75rem; padding: 0 0.4rem; }
        .pagination-info { font-size: 0.75rem; }
        .pagination { margin-top: 1rem; padding: 0.75rem 0; gap: 0.25rem; }
    </style>
</head>
                    ...
                    <div class="admin-content-wrapper">
                        ...
                        <div class="search-card">
                            <form method="GET" class="search-form">
                                <div class="filters-grid-fullwidth">
                            ...
                            <?php if (empty($customers)): ?>
                                <div class="empty-state">
                                    ...
                                    <p style="color: var(--muted);">
                                        <?php echo $search ? 'Try adjusting your search' : 'Waiting for first customer signup'; ?>
                                    </p>
                                </div>
                            <?php else: ?>
                                <table class="customers-table">
                                    <thead>
                                        <tr>
                                            <th>Customer</th>
                                            <th>Email</th>
                                            <th style="white-space: nowrap;">Total Orders</th>
                                            <th style="white-space: nowrap;">Total Spent</th>
                                            <th style="white-space: nowrap;">Last Order</th>
                                            <th>Joined</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($customer['total_orders'] > 0): ?>
                                                        <span class="badge badge-success"><?php echo $customer['total_orders']; ?> orders</span>
                                                    <?php else: ?>
                                                        <span class="badge badge-muted">No orders</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td><strong>P<?php echo number_format($customer['total_spent'], 2); ?></strong></td>
                                                <td>
                                ...
                                <?php if ($total_pages > 1): ?>
                                    <div class="pagination">
                                        ...
                                        <?php if ($current_page > 1): ?>
                                            <a href="?page=<?php echo $current_page - 1; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="pagination-btn">‹ Prev</a>
                                        <?php else: ?>
                                        ...
                                        if ($start_page > 1):
                                        ?>
                                            <a href="?page=1<?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="pagination-btn">1</a>
                                            <?php if ($start_page > 2): ?>
                                        ...
                                        <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                                            ...
                                            <?php else: ?>
                                                <a href="?page=<?php echo $i; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="pagination-btn"><?php echo $i; ?></a>
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                        ...
                                        <?php if ($end_page < $total_pages): ?>
                                            <?php if ($end_page < $total_pages - 1): ?>
                                                <span class="pagination-btn disabled">...</span>
                                            <?php endif; ?>
                                            <a href="?page=<?php echo $total_pages; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="pagination-btn"><?php echo $total_pages; ?></a>
                                        <?php endif; ?>

                                        <?php if ($current_page < $total_pages): ?>
                                            <a href="?page=<?php echo $current_page + 1; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="pagination-btn">Next ›</a>
                                        <?php else: ?>
